...
* title = "Patient Health Questionnaire - Questionnaire"
* attester.mode = #legal
...
* section[+].title = "PHQ9"
* section[=].text.status = #generated
* section[=].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">Patient Health Questionnaire 7</div>"
* section[=].entry[0] = Reference(Questionnaire/example-PHQ9)
