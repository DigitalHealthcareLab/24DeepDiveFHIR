...
* title = "Generalized Anxiety Disorder - Questionnaire"
* attester.mode = #legal
...
* section[+].title = "GAD7"
* section[=].text.status = #generated
* section[=].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">Generalized Anxiety Disorder 7</div>"
* section[=].entry[0] = Reference(Questionnaire/example-GAD7)
