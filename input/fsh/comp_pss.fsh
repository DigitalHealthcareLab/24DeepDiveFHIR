...
* title = "Perceived Stress Scale - Questionnaire"
* attester.mode = #legal
...
* section[+].title = "PSS10"
* section[=].text.status = #generated
* section[=].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">Perceived Stress Scale 7</div>"
* section[=].entry[0] = Reference(Questionnaire/example-PSS10)
